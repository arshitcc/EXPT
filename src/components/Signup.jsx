...
function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
        ...
        setLoading(true);
        const user = await authService.createAccount({userEmail, userPassword});
        if(user){
                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form onSubmit={handleSignup} className="space-y-4 md:space-y-6" action="#">
                        <div>
                            ...
                            type="email" name="userEmail" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required=""/>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            type="confirm-password" name="userConfirmPassword" id="confirm-password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required=""/>
                        </div>
